...
# may contain splits
parser.add_argument('--weights', type=str, default="./checkpoint/TSM_biovid5_RGB_resnet50_shift8_blockres_avg_segment16_e50_lr1e-03_val")
...
bio_test = [1, 6, 16, 21, 24, 28, 46, 55, 58, 63, 65, 69, 73, 77, 83, 86]
